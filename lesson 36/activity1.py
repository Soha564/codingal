...
background_image = pygame.transform.scale(pygame.image.load("Screenshot_20-9-2025_12529_www.bing.com.jpeg"), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
# Create sprites
sprite1 = Sprite(pygame.Color('darkorange'), 20, 30)
